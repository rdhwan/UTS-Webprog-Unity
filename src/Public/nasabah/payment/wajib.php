...
<body class="flex flex-col min-h-screen min-w-full font-inter p-4 md:p-8 bg-[url('../images/bgCube.png')]">
    ...
    <div class="flex flex-1 h-full my-4 justify-center">
        <div
            class="flex flex-1 flex-col md:flex-row mb-12 md:mb-4 rounded-3xl bg-gradient-to-b from-[#E178C5] to-[#FFB38E] justify-center items-center p-8 pt-2 md:pb-8 md:py-12 md:pr-12 md:pl-12 w-full">
            <div class="flex flex-col w-full lg:w-[50%] h-[100%] justify-between  pr-[1rem]">
                <div class="flex flex-col items-start w-full  py-[2rem] md:py-0">
                    ...
                    <label class="font-bold text-5xl md:text-7xl text-[#FFFDCB] ">
                        Wajib
                    </label>
                </div>
                        ...
                        <div class="form-control">
                            <label class="label cursor-pointer">
                                <input type="radio" name="category" value="W"
                                    class="radio checked:bg-[rgb(175,175,175)]" checked />
                        ...
                        <div class="form-control">
                            <label class="label cursor-pointer">
                                <input type="radio" name="category" value="S"
                                    class="radio checked:bg-[rgb(175,175,175)] ml-[1rem]" disabled />
